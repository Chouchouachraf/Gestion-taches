        ...
        <div class="d-flex justify-content-end mb-3">
            <form method="get" action="" class="d-inline">
                <select name="sort" class="form-select" style="width: auto;" onchange="this.form.submit()">
                    <option value="priority" <?= isset($_GET['sort']) && $_GET['sort'] === 'priority' ? 'selected' : '' ?>>Sort by Priority</option>
                    <option value="due_date" <?= isset($_GET['sort']) && $_GET['sort'] === 'due_date' ? 'selected' : '' ?>>Sort by Due Date</option>
                </select>
            </form>
        </div>
